...
import os
import torch
from exp.exp_long_term_forecasting2 import Exp_Long_Term_Forecast   ######
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str, required=True, default='Economy', help='dataset type')
    ...
    fix_seed = args.seed
    #args.prompt_weight=args.prior_weight    # ours 돌릴 때 주석처리해야함
    ...
    if args.is_training:
        ...
        ii = 0
        setting = '{}_{}_{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_pw{}_{}_{}'.format(
            args.task_name,
            args.model_id,
            args.model,
            args.data_name,
